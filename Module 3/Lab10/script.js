...
// The purpose of this application is to demnostrate the use of arrays and web storage within an application.
// Within this application we will be building a task manager that allows the user to create a task. That task will be persisted 
// to web storage and shown visably within a textarea form object. As new tasks are added the list grows and is automatically sorted within 
// the textarea. The user will optionally be able to clear all tasks from web storage which will also clear the tasks from the textarea.
